...
from intermediate_representation.semQL import Sup, Sel, Order, Root, Filter, A, N, Op, C, T, V, Root1
...
class Test(TestCase):
    def test_filter_column_value_quadruplets(self):
        # Given
        query_as_semql = [Root1(3), Root(3), Sel(0), N(0), A(0), Op(0), C(27), T(7), C(27), T(7), Filter(2), A(0), Op(0), C(13), T(1), C(13), T(1), V(0)]
        ...
        self.assertEqual(str(quadruplets[0][1]), str(Op(0)))
        self.assertEqual(str(quadruplets[0][2]), str(C(27)))
        self.assertEqual(str(quadruplets[0][3]), str(T(7)))
        self.assertEqual(str(quadruplets[0][4]), str(C(27)))
        self.assertEqual(str(quadruplets[0][5]), str(T(7)))


        self.assertEqual(str(quadruplets[1][0]), str(A(0)))
        self.assertEqual(str(quadruplets[1][1]), str(Op(0)))
        self.assertEqual(str(quadruplets[1][2]), str(C(13)))
        self.assertEqual(str(quadruplets[1][3]), str(T(1)))
        self.assertEqual(str(quadruplets[1][4]), str(C(13)))
        self.assertEqual(str(quadruplets[1][5]), str(T(1)))
        self.assertEqual(str(quadruplets[1][6]), str(V(0)))
    ...
    def test_resolve_quadruplet(self):
        ...
        quadruplets = filter_column_value_quadruplets(
            [Root1(3), Root(3), Sel(0), N(0), A(0), Op(0), C(27), T(7), C(27), T(7), Filter(2), A(0), Op(0), C(13), T(1), C(13), T(1), V(0)])
