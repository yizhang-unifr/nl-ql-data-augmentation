...
class Sup(Action):
    ...
    def _init_grammar(self):
        self.grammar_dict = {
            # this is different to the paper, where the rules are called "most A" or "least A". That would make a bit more sense I think.
            0: 'Sup des A',
            1: 'Sup asc A',
        }
        self.production_id = {}
...
# Add Op Class for the Arithmetic Operators
